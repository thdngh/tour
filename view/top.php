  ...
  <div class="container" style="width:1500px; margin-left:15px; margin-right:200px;">
    ...
    <div class="collapse navbar-collapse" id="myNavbar" >
      <ul class="nav navbar-nav">
        ...
        <li><a class="nav-link" href="?action=khuyenmai"><img src="images/km.png" width="28px" height="28px"></span> Khuyến Mãi</a></li>
		<li><a class="nav-link" href="?action=gioithieu"><span class="	glyphicon glyphicon-bullhorn" style="margin-top:3px;"></span> Giới thiệu</a></li>
        <li><a class="nav-link" href="?action=lienhe"><span class="glyphicon glyphicon-phone-alt"  style="margin-top:3px;"></span> Liên hệ</a></li>
    ...
    <?php 
		...
		<li class="dropdown" style="width:158px;">
			 <a class="dropdown-toggle" data-toggle="dropdown" href="#">
				<span class="glyphicon glyphicon-user" style="margin-top:3px;"></span> Tài khoản <span class="caret"></span>
			  </a>
