...
<body>
<div class="bg-img" >
  <form  method="post" action="index.php" class="container" style ="right:23%; margin:12%;" >
  <?php if (isset($tb) && $tb != ""){ ?>
	...
	<a href="index.php"><span></span>Trang Chủ</a></li>
	<a href="admin/ktnguoidung/loginad.php"><span></span>Đổi mật khẩu</a></li>
  </form>
</div>
</body>
</html>